...
const ASSETS = [
  ".",
  "index.html",
  "css/styles.css?v=0.2.2",
  "js/db.js?v=0.2.2",
  "js/ocr.js?v=0.2.2",
  "js/ui.js?v=0.2.2",
  "js/voice.js?v=0.2.2",
  "js/ki.js?v=0.2.2",
  "js/profil.js?v=0.2.2",
  "js/documents.js?v=0.2.2",
  "js/formulare.js?v=0.2.2",
  "js/mediplan.js?v=0.2.2",
  "js/notfall.js?v=0.2.2",
  "js/pflege.js?v=0.2.2",
  "js/gesundheit.js?v=0.2.2",
  "js/angehoerige.js?v=0.2.2",
  "js/erinnerungen.js?v=0.2.2",
  "js/kontakte.js?v=0.2.2",
  "js/app.js?v=0.2.2",
  "manifest.json",
  "icons/icon.svg",
  "icons/icon-180.png",
