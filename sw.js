...
const ASSETS = [
  ...
  "js/ui.js?v=0.1.7",
  "js/ki.js?v=0.1.7",
  "js/profil.js?v=0.1.7",
  "js/documents.js?v=0.1.7",
  "js/formulare.js?v=0.1.7",
  "js/mediplan.js?v=0.1.7",
  "js/notfall.js?v=0.1.7",
  "js/pflege.js?v=0.1.7",
  "js/gesundheit.js?v=0.1.7",
  "js/angehoerige.js?v=0.1.7",
  "js/erinnerungen.js?v=0.1.7",
  "js/app.js?v=0.1.7",
  "manifest.json",
  "icons/icon.svg",
];
