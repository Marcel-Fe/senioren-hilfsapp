...
const ASSETS = [
  ".",
  "index.html",
  "css/styles.css?v=0.3.3",
  "js/db.js?v=0.3.3",
  "js/ocr.js?v=0.3.3",
  "js/ui.js?v=0.3.3",
  "js/voice.js?v=0.3.3",
  "js/ki.js?v=0.3.3",
  "js/profil.js?v=0.3.3",
  "js/documents.js?v=0.3.3",
  "js/formulare.js?v=0.3.3",
  "js/mediplan.js?v=0.3.3",
  "js/notfall.js?v=0.3.3",
  "js/pflege.js?v=0.3.3",
  "js/gesundheit.js?v=0.3.3",
  "js/angehoerige.js?v=0.3.3",
  "js/erinnerungen.js?v=0.3.3",
  "js/kontakte.js?v=0.3.3",
  "js/assistent.js?v=0.3.3",
  "js/app.js?v=0.3.3",
  "manifest.json",
  "icons/icon.svg",
  "icons/icon-180.png",
