...
const ASSETS = [
  ...
  "js/ui.js?v=0.1.1",
  "js/ki.js?v=0.1.1",
  "js/profil.js?v=0.1.1",
  "js/documents.js?v=0.1.1",
  "js/formulare.js?v=0.1.1",
  "js/mediplan.js?v=0.1.1",
  "js/notfall.js?v=0.1.1",
  "js/pflege.js?v=0.1.1",
  "js/gesundheit.js?v=0.1.1",
  "js/app.js?v=0.1.1",
  "manifest.json",
  "icons/icon.svg",
];
