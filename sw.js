...
const ASSETS = [
  ...
  "js/ui.js?v=0.1.6",
  "js/ki.js?v=0.1.6",
  "js/profil.js?v=0.1.6",
  "js/documents.js?v=0.1.6",
  "js/formulare.js?v=0.1.6",
  "js/mediplan.js?v=0.1.6",
  "js/notfall.js?v=0.1.6",
  "js/pflege.js?v=0.1.6",
  "js/gesundheit.js?v=0.1.6",
  "js/angehoerige.js?v=0.1.6",
  "js/erinnerungen.js?v=0.1.6",
  "js/app.js?v=0.1.6",
  "manifest.json",
  "icons/icon.svg",
];
