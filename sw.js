...
const ASSETS = [
  ".",
  "index.html",
  "css/styles.css?v=0.3.0",
  "js/db.js?v=0.3.0",
  "js/ocr.js?v=0.3.0",
  "js/ui.js?v=0.3.0",
  "js/voice.js?v=0.3.0",
  "js/ki.js?v=0.3.0",
  "js/profil.js?v=0.3.0",
  "js/documents.js?v=0.3.0",
  "js/formulare.js?v=0.3.0",
  "js/mediplan.js?v=0.3.0",
  "js/notfall.js?v=0.3.0",
  "js/pflege.js?v=0.3.0",
  "js/gesundheit.js?v=0.3.0",
  "js/angehoerige.js?v=0.3.0",
  "js/erinnerungen.js?v=0.3.0",
  "js/kontakte.js?v=0.3.0",
  "js/assistent.js?v=0.3.0",
  "js/app.js?v=0.3.0",
  "manifest.json",
  "icons/icon.svg",
  "icons/icon-180.png",
